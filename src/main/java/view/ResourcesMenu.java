...
public class ResourcesMenu {
    ...
    */
    public void update() {
        ...
        lblStart = new Label("Strategy Level: "
        ...
        lblHappiness = new Label("Happiness: "
            + civ.getHappiness());
        hbox.getChildren().addAll(lblStart, lblResources,
            lblSettlements, lblMoney, lblFood, lblHappiness);
    }
    /**
